    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {devices.map(device => {
          ...
          const isIsolated = live?.is_isolated ?? device.is_isolated
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <span className={`w-2 h-2 rounded-full ${isIsolated ? 'bg-red-500' : 'bg-green-400 animate-pulse'}`} />
              </div>
              ...
              {live && (
                <div className="grid grid-cols-2 gap-2 mb-3 text-xs">
                  {[
                    ...
                    ['Pressure',live.pressure,    'bar'],
                    ['Flow',    live.flow_rate,   'L/m'],
                    ['Voltage', live.voltage,     'V'],
                  ].map(([k, v, u]) => (
              ...
              {/* Isolate button */}
              <button
                onClick={() => handleIsolate(device.device_id, isIsolated)}
