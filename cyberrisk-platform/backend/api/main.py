    ...
    try:
        ...
        if state["anomaly"].get("is_anomaly") and state["report"].get("report_id"):
            ...
            incident_data = {
                ...
                "status": inc.status,
                "is_isolated": inc.is_isolated,
                "nist_report": inc.nist_report,
                "credit_brief": inc.credit_brief,
            }
        ...
        await ws_manager.broadcast({
            ...
            "device_id": payload["device_id"],
            "device_type": payload.get("device_type", getattr(device, "device_type", "factory")),
            "location": payload.get("location", getattr(device, "location", "Unknown")),
            "temperature": payload["temperature"],
            "pressure": payload["pressure"],
            "flow_rate": payload["flow_rate"],
            "voltage": payload["voltage"],
            ...
            "is_isolated": device.is_isolated,
